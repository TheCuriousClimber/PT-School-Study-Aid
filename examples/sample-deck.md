# Sample output — Ankle sprain (demo)

This is a small, hand-written example of what the SCALE Engine v2 prompt produces, so you can try the study app before you have a real deck. Values are typical textbook figures. Verify everything against your own lecture before you study it.
...
|---|---|---|---|---|---|
| LO 1 | Describe the mechanism of injury and the ligaments involved in a lateral ankle sprain | Explain | Lecture 4, slides 3–9 | High | Repeated on summary slide, ties to special tests |
| LO 2 | Grade ankle ligament sprains (I–III) from clinical findings | Apply | Lecture 4, slides 10–14 | High | Grading table, flagged "know this" |
| LO 3 | Apply the Ottawa Ankle Rules to decide whether radiographs are indicated | Apply | Lecture 4, slides 15–18 | High | Named clinical prediction rule with criteria |
| LO 4 | Perform and interpret the anterior drawer and talar tilt tests | Perform | Lab handout, pages 2–3 | High | Practical exam skill |
| LO 5 | Describe the epidemiology of ankle sprains | Recall | Lecture 4, slide 2 | Low | Mentioned once, no clinical decision attached |
...
|---|---|---|---|---|
| Day 1 | Learn | 25 | Tier 1 cards, new only | Timer ends, even if cards remain |
| Day 2 | Review + learn | 25 | Due cards, then Tier 2 | Timer ends |
| Day 3 | Review + practice | 15 + 20 | Due cards, then anterior drawer and talar tilt on a partner | Both tests performed correctly twice |
| Day 4 | Review + simulate | 15 + 20 | Due cards, then the exam simulation closed-book | All four questions attempted |
| Day 5 | Review | 10 | Due cards only | Due queue empty |

Finishing this plan is the definition of done for this week.
